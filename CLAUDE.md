...
4. Create a reviewer agent with prompt: "this branch is created by codex, review carefully and generate an html report"
...
- If current workspace is developing a new feature, create a new worktree under `.claude/`
